...
# =====================================================================
# 1. FONCTIONS MATHÉMATIQUES, ALGORITHMES ET DESSIN (Issues de app_v2.py)
# =====================================================================
...
with col2:
    ...
    if fichier_upload is not None and btn_generer:
        with st.spinner("Calculs et assemblage en cours..."):
            ...
            # --- Conversion pour la compatibilité d'affichage ---
            ...
            # Choix intelligent du moteur de rendu
            if choix_algo in ["Méta-Heuristique (Aléatoire)", "Hongrois (Matteo)"]:
                image_mosaique = creer_mosaique_finale(emplacements, placements_bruts, largeur_grille, hauteur_grille, taille_case=80)
            else:
            ...
            # encodage de l'image en texte  (base64) pour pouvoir l'envoyer au navigateur html
